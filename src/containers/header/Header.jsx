...
import { carousel01, carousel02, carousel03, carousel04, } from './imports';

const images = [carousel01, carousel02, carousel03, carousel04];
    ...
    <div className="gpt3__header section__padding" id="home">
      <div className="gpt3__header-content">
        <h1 className="gradient__text">
          Solving Natural Resource Challenges With Science For Over 30 Years
        </h1>
